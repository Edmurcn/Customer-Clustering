...
def evaluation_model_multclass_classifier(models, X, y):
    ...
    fig, axs = plt.subplots(n_row_max, 4, figsize=(18, (3.5*n_row_max)), facecolor="lightgray")
    ...
    #     axs[position((2*i)+1)].set_xlabel("False Positive Rate", fontsize=12)
    #     axs[position((2*i)+1)].set_ylabel("True Positive Rate", fontsize=12)
